...
public class Test_Statistics_Sharing_Distance extends Agent {
	private static final long serialVersionUID = 367436229954674482L;
	...
	protected void setup() {
		...
		try {
			...
			AgentController station = cc.createNewAgent("station-sharing-distance", "agents.TaxiStationAgent", stationArgs);
			station.start();
			agents.add(station);
